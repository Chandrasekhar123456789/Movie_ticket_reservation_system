 					...
 					<div class="card bg-light mt-2">
 						<div class="card-body">
 							...
 							<form action="" id="save-reserve">
 								...
 								<div class="row">
 									<button class="col-md-2 btn btn-block btn-primary" id="booknow">Book</button>
 								</div>
 							</form>

							 <?php
    							if ($_SERVER["REQUEST_METHOD"] == "POST") {
        						// You can add your ticket booking logic here, like saving to the database.
        						echo "<script>alert('Your ticket has been successfully booked!');</script>";
    							}
    							?>
